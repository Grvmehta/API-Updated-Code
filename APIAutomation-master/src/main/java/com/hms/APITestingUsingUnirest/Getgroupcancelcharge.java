...
static String responseJSONString;
	...
	public void Getgroupcancelchargecall(String s1, String s2)
	{
		...
		try
		{
			...
			getbookingsobj1.Getbookingscallforreserveguest("login");
			String editbookingtempid1 = getbookingsobj1.extractinggroupmainid();
			Editbooking editbookingobj = new Editbooking();
			editbookingobj.fn_editbookingcallforexistingbookingid("login", editbookingtempid1, "G");

		    editbookinggroupid = editbookingobj.extracttinggroupid();	
			System.out.println("after editbookingscall:::");
			System.out.println("maya"+editbookinggroupid);
	...
	public String extractingmessagegetgroupcancellationcharge()
	{
		...
		finally
		{
			...
			commiteditbookingobj.CommiteditBookingCallForExistingBookingid("login", "G", editbookinggroupid);
		}
