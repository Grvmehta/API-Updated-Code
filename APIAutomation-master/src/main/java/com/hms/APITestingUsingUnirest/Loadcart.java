...
public class Loadcart
{
	static String responseJSONString;
	 ...
	 public void loadcartforFrontDeskfor3DResv(String s1){
		 keytype = s1;
		 ...
		 addtocartobj.AddtocartforFrontDeskfor3DResv(keytype);
		 ...
		 JsonNode body = responseloadcart.getBody();
		 responseJSONString = body.toString();
		 System.out.println("Respns of Loadtocaryt for FD"+responseJSONString);
		 }
	 ...
	 public void loadcartforgroupresv(String s1, String s2){
		 keytype = s1;
		 Noofadult = s2;
		 if(keytype == "wsauth")
		 {
		 ...
		 System.out.println("hello accesskey:"+accesskey);
		 Addtocart addtocartobj = new Addtocart();
		 addtocartobj.Addtocartforgroupresv(keytype, Noofadult);

		             accesskey = addtocartobj.accesskey;
		 HttpResponse<JsonNode> responseloadcart = Unirest.post(""+serverurl+"/ws/web/loadcart")
		 .header("content-type", "application/json")
		 .header("x-ig-sg", "D_gg%fkl85_j")
		 .header("cache-control", "no-cache")
	 ...
	 public void LoadcartcallforfrontdeskforFutureDate(String s1,String s2){
 keytype = s1;
 Noofroom=s2;		 
		 if(keytype == "wsauth")
			{
		 ...
		 try
		 {
			 ...
			 System.out.println("hello accesskey:"+accesskey);
			 Addtocart addtocartobj = new Addtocart();
			 addtocartobj.AddtocartcallforFrontDeskforfutureDate(keytype,Noofroom);
	 ...
	 public void Loadcartcallforfrontdesk(String s1){
        ...
        keytype = s1;
		 ...
		 try
		 {
			 ...
			 System.out.println("hello accesskey:"+accesskey);
			 Addtocart addtocartobj = new Addtocart();
			 addtocartobj.AddtocartcallforFrontDesk(keytype);
	 ...
	 public void loadcartforgroupresv(String s1){
		 keytype = s1;
		 ...
		 System.out.println("hello accesskey:"+accesskey);
		 Addtocart addtocartobj = new Addtocart();
		 addtocartobj.Addtocartforgroupresv(keytype);
	 ...
	 {
		 return rateId=addtocartobj.rateId;
	 }
