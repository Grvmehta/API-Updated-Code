...
static String responseJSONString;
	...
	public void unassignroomcallaftermethod(String s1,String s2){
		keytype = s1;
		String ResType=s2;
		System.out.println("keytype in unassignroom:"+s1);
		...
		getbookingsobj.Getbookingscall("login","RESERVE");
		...
		HttpResponse<JsonNode> responseunassignroom = Unirest.post(""+serverurl+"/ws/web/unassignroom")
		 ...
		 .asJson();
		 JsonNode body = responseunassignroom.getBody();
		 System.out.println("unassignroom Before Method:"+body);
		 responseJSONString = body.toString();
		 }
		 catch(UnirestException e)
		 {
	...
	public String extractingmessageunassignroom()
	{
		try
		{
			...
			System.out.println("at last unassignroom success :"+getgroupcancellationchargestring);
			return getgroupcancellationchargestring;
		}
		finally
		{
			System.out.println("unassignroom finally block ::");
