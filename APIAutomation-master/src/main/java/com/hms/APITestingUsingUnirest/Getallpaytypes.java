...
public class Getallpaytypes
{
		 ...
		 public void Getallpaytypescall(String s1)
		 {
			 ...
			 System.out.println("Response of getallpaytypes"+responseJSONString);
			 }
		 ...
		 public String extractingmessageGetallpaytypes()
		 {
			 ...
			 JSONObject jsonobj1 = jsonResult.getJSONObject("hotelogix");
			 JSONObject jsonobj2 = jsonobj1.getJSONObject("response");
			 String getallpaytypessuccessstring =jsonobj2.getJSONObject("status").getString("message");			 
			 JSONArray arrobj = jsonobj2.getJSONArray("hotels");
			 JSONObject jsonobj =arrobj.getJSONObject(0);
			 JSONArray 	arrobj2 =jsonobj.getJSONArray("payTypes");
			 paymentmode = arrobj2.getJSONObject(0).getString("paymentMode");
			 paytype = arrobj2.getJSONObject(0).getString("shortname");		 
