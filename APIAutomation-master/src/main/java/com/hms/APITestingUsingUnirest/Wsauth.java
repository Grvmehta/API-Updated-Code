...
public class Wsauth
{
	 ...
	 public void Wsauthcall()
	{
		...
		try {
		 ...
		 public void WsauthcallforTA()
			{
				System.out.println("hello wsauthcall for TA");
				try {		
					serverurl= CommonConfig.serverurl;
					System.out.println("rajni kant::"+serverurl);
					key = CommonConfig.TAKey;
					System.out.println("rajni kant key ::"+key);
					...
					JsonNode body = response1.getBody();
					System.out.println("This is request" +body);
					
					//converting to gson for extracting keys
					Gson gson = new Gson();
				    responseJSONString = response1.getBody().toString();
				    System.out.println("check wasauthcall response::"+responseJSONString);
	 ...
	 public void WsauthcallforCorp()
	 {
	 System.out.println("hello wsauthcall for TA");
	 try {
	 serverurl= CommonConfig.serverurl;
	 System.out.println("rajni kant::"+serverurl);
	 key = CommonConfig.CorpKey;
	 System.out.println("rajni kant key ::"+key);
