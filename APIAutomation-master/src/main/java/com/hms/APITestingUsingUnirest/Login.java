...
public class Login extends Getcounters
{
	...
	public void LogincallforLogoutusers(){
		Getcounters objgetcounter = new Getcounters();
		objgetcounter.Getcounterscall();
		System.out.println("hello login");
		Counterid = objgetcounter.extractingdefaultcounterid();
		System.out.println("getcounter value in Logincall::"+Counterid);
		try {
			serverurl= CommonConfig.serverurl;
			key=CommonConfig.key;
			hotelid1=CommonConfig.hotelid1;
			emailid=CommonConfig.emailid2;
			password=CommonConfig.password;
