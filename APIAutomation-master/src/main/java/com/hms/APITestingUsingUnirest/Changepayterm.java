...
//String groupmainid = confirmbookingobj.extracinggroupid();
groupcode = confirmbookingobj.extractinggroupcode();

Getgroup getgroupobj = new Getgroup();
getgroupobj.Getgroupcall("login", groupcode);
String groupmainid =getgroupobj.extractinggetgroupidmain();

Editbooking editbookingobj =  new Editbooking();
editbookingobj.fn_editbookingcallforexistingbookingid("login", groupmainid, "G");
