...
Getbookings getbookingsobj = new Getbookings();
getbookingsobj.Getbookingscallforreserveguest(keytype);
String bookingmainid = getbookingsobj.extractingmainid();

Commiteditbooking commiteditbookingobj = new Commiteditbooking();
commiteditbookingobj.CommiteditBookingCallForExistingBookingid("login", "S", bookingmainid);

//getting roomtype id and roomid
Gethousestatus gethousestatusobj = new Gethousestatus();
gethousestatusobj.Gethousestatuscall("login");
String roomtypid = gethousestatusobj.extractingroomtypeids();
String roomid = gethousestatusobj.extractingunassignroomsid();
System.out.println(roomtypid);
