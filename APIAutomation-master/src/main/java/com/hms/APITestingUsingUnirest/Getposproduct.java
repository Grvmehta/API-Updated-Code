...
public class Getposproduct
{
 String responseJSONString;
	 ...
	 public String extractingposproductid(){
		 System.out.println("welcome to extractingposproductid");
			String localresponseJSONString = responseJSONString;
			System.out.println(localresponseJSONString);
			JSONObject jsonResult = new JSONObject(localresponseJSONString);
			JSONArray getbookingsArray = jsonResult.getJSONObject("hotelogix").getJSONObject("response").getJSONArray("products");
			System.out.println(getbookingsArray.length());
			JSONObject prdObj=getbookingsArray.getJSONObject(0);
			price = prdObj.getString("price");	
			System.out.println("Price is: +price");
			ProductId=prdObj.getString("id");
