...
public class Commiteditbooking
{
	...
	public void CommiteditBookingCallForExistingBookingid(String s1,String s2, String s3)
	{
	keytype = s1;
	bookingType = s2;
	editbookingid= s3;
	...
	System.out.println("editbooking temp id in commiteditbooking"+editbookingid);
	...
	System.out.println("commiteditbooking:"+body);
	responseJSONString = body.toString();
	System.out.println("Commiteditbookingstatus:::"+responsecommiteditbooking.getStatus());
...
public void CommiteditbookingcallforFDBooking(String s1){
keytype = s1;
System.out.println("keytype:"+s1);
...
{
serverurl = CommonConfig.serverurl;
System.out.println("editbooking id call from guest chk in....");
GuestCheckin guestcheckinobj=new GuestCheckin();
editbookingid=guestcheckinobj.editbookigid;
System.out.println("EXTRACT BOOKING ID FROM GUEST CHK IN:"+editbookingid);
