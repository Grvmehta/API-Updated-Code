...
static String responseJSONString;
	...
	public void GetaccountstatementcallforGRPReservation(String s1) {
		keytype = s1;
		...
		try
		{
			...
			Editbookingobj.Editbookingcall(keytype, "G","RESERVE");
		...
		finally
		{
			 ...
			 commiteditbookingobj.CommiteditBookingCallForExistingBookingid(keytype, "G", Editbookingid);
		}
	}
	...
	public String extractingTransactionsInGetAccountstatement()
	{
		String localresponseJSONString = responseJSONString;
		JSONObject jsonResult = new JSONObject(localresponseJSONString);
		String getaccountstatementstring;
		 JSONObject jsonResult1=  (JSONObject) jsonResult.getJSONObject("hotelogix").getJSONObject("response").getJSONArray("transactions").get(0);
		 getaccountstatementstring= jsonResult1.getString("id");
		 System.out.println("at last closeeditbooking success :"+getaccountstatementstring);
		return getaccountstatementstring;
	} 
	
	public void GetaccountstatementcallForExistingBookingID(String keyType,String mainID)
	{
		keytype = keyType;
